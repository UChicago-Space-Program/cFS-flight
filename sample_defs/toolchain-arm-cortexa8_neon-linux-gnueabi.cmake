...
# Limit pkg-config to the target sysroot so host-side optional deps are ignored.
set(ENV{PKG_CONFIG_LIBDIR} "/usr/lib/arm-linux-gnueabihf/pkgconfig")
set(ENV{PKG_CONFIG_SYSROOT_DIR} "/")

# Disable optional host-only features for the ARM cross build.
# (Leave unset so the build can enable features when dependencies are present.)
