...
/*
** File: comms_lib_stubs.c
**
** Purpose:
** Unit test stubs for the COMMS library
**
** Notes:
...
int32 COMMS_LIB_Init(void)
{
     ...
     */
    return UT_DEFAULT_IMPL(COMMS_LIB_Init);
}

/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/*                                                                 */
/* Comms Lib function stub                                        */
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
int32 COMMS_LIB_Function(void)
{
    return UT_DEFAULT_IMPL(COMMS_LIB_Function);
}
